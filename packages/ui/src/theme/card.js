export const card = {
	default: {
		card: "flex flex-col rounded-lg shadow-lg bg-red-500 overflow-hidden text-black",
		image: "flex-shrink-0",
		body: "px-4 py-3",
	...
	inline: {
		card: "flex flex-row rounded-lg shadow-lg overflow-hidden text-black",
	...
	inlineInversed: {
		card: "flex flex-row-reverse rounded-lg shadow-lg overflow-hidden text-black",
		image: "flex-shrink-0 w-1/2",
