...
const classes = {
	base: "focus:outline-none transition ease-in-out duration-300 text-white border border-solid",
	...
	variant: {
		primary:
			"bg-indigo-600 border-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-white",
		secondary:
	...
	outlineVariant: {
		primary: `bg-transparent border-indigo-600 text-indigo-600 hover:text-white hover:bg-indigo-600`,
	...
	(
		...
		<button
			...
			className={clsx(
				classes.base,
				classes.size[size],
				!outline ? classes.variant[variant] : classes.outlineVariant[variant],
				pill && classes.pill,
