export const slider = {
	default: {
		...
		arrows: {
			wrapper:
				"text-indigo-700 absolute top-1/2 -translate-y-1/2 items-center justify-center cursor-pointer py-2 px-2 text-indigo-500 hover:bg-indigo-500 hover:text-white rounded-full  transition transition-all ease-in-out delay-200 rtl:rotate-180",
		...
		dots: {
			...
			dot: "w-3 h-3 bg-black opacity-10 md:px-20 p-2 md:p-1 cursor-pointer  ",
			dotActive:
				"w-2 h-3 text-white opacity-100 bg-gradient-to-l from-white to-indigo-500 md:px-20 p-2 md:p-1 sm:transition sm:ease-in-out sm:delay-100 ",
		},
	},
	iconSlider: {
		...
		arrows: {
			wrapper:
				"md:invisible text-indigo-700 absolute top-1/2 -translate-y-1/2 items-center justify-center cursor-pointer py-2 px-2 border border-solid border-indigo-500 text-indigo-500 hover:bg-indigo-500 hover:text-white rounded-full  transition transition-all ease-in-out delay-200 rtl:rotate-180",
			left: "left-12 rtl:left-auto rtl:right-12 ",
			right: "right-12 rtl:right-auto rtl:left-12",
		},
		dots: {
			wrapper: "md:invisible flex items-center justify-center bottom-10",
			dot: "w-2 h-2 bg-slate-500 md:px-20 p-2 md:p-1 cursor-pointer  rounded-full ",
			dotActive:
	...
	cardSlider: {
		...
		arrows: {
			wrapper:
				"text-blue-1000 absolute top-1/2 -translate-y-1/2 items-center justify-center cursor-pointer py-2 px-2 text-indigo-500 hover:bg-indigo-500 hover:text-white rounded-full  transition transition-all ease-in-out delay-200 rtl:rotate-180",
			left: "left-12 rtl:left-auto rtl:right-12 ",
			right: "right-12 rtl:right-auto rtl:left-12",
		},
		dots: {
