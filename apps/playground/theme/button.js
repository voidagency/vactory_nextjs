export const button = {
	...
	variant: {
		...
		secondary:
			"text-gray-700 bg-white border border-solid border-gray-300 shadow-[0px_1px_2px_rgba(16,24,40,0.05)] hover:shadow-[0px_1px_2px_rgba(16,24,40,0.05),0px_0px_0px_4px_rgba(242,244,247,1)] active:bg-gray-50",
		danger:
